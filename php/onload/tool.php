<?php
  ...
  if(isset($_GET["diseaseSubmitted"])){ # Display out a confirmation if a new disease has been added to the database and the user has been redirected here.
    echo($popupTop.'<p>Disease has now been submitted. You can now add new sequences to that disease.</p>'.$popupBottom);
  }
  else if(isset($_GET["sequenceSubmitted"])){ # Display out a confirmation if a new sequence has been added to the database and the user has been redirected here.
